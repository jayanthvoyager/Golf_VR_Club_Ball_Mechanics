...
public class GolfBall1 : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		// magnus effect
		if (magnusConstant > 0)
			rigidbody.AddForce(magnusConstant * Vector3.Cross(rigidbody.angularVelocity, rigidbody.linearVelocity));

		// end shot conditions
		if (Time.frameCount > hitFrame + 10 && rigidbody.linearVelocity.magnitude < 0.25f)
		{
